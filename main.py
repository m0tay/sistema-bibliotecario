											...
											case '1':
												...
												if book:
													...
													subtitle_input = get_non_empty_input(
														f'Subtitle ({book.sub_title}): ',
														optional=True,
														default=book.sub_title,
													)
													...
													synopsis_input = get_non_empty_input(
														f'Synopsis ({book.synopsis}): ',
														default=book.synopsis,
													)
						...
						case '2':
							while True:
								...
								match user_input:
									...
									case '3':
										user = []
										while not user and user_input != 'q':
											user_input = input('Select user (by id): ')
											t.clear_cli()

											user = db.read(User, id=user_input)

											if not user:
												print('Maybe this user does not exist')
											...
											case '1':
												...
												if user:
													...
													db.edit(
														...
														age=age_input,
														gender=gender_input,
														register_date=register_date_input,
													)  # pyright: ignore
